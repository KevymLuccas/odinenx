...
<template>
  <div class="dashboard">
    ...
    <main class="main-content">
      <header class="page-header"><h1>Módulo BET</h1><p>Análise de apostas esportivas com IA</p></header>

      <div class="coming-soon">
        <div class="icon-wrapper"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg></div>
        <h2>Em Desenvolvimento</h2>
        <p>O módulo BET está sendo construído com as melhores tecnologias de análise esportiva.</p>
        <div class="features-preview">
          <div class="feature"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg><span>Análise de odds em tempo real</span></div>
          <div class="feature"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg><span>Estatísticas de times e jogadores</span></div>
          <div class="feature"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg><span>Previsões com Machine Learning</span></div>
          <div class="feature"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg><span>Alertas de value bets</span></div>
        </div>
      </div>
    </main>
  </div>
...
.icon-wrapper { width: 100px; height: 100px; background: rgba(34, 197, 94, 0.15); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 30px; }
.icon-wrapper svg { width: 50px; height: 50px; stroke: #22c55e; }
...
.feature svg { width: 20px; height: 20px; stroke: #22c55e; flex-shrink: 0; }
