  ...
  <div class="dashboard">
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <router-link to="/bet" class="nav-item active">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<style scoped>
/* ===== DASHBOARD LAYOUT - Igual ao Dashboard.vue ===== */
.dashboard { display: flex; min-height: 100vh; min-height: 100dvh; background: #000; color: #fff; }

/* Sidebar */
.sidebar { width: 260px; background: rgba(255, 255, 255, 0.02); border-right: 1px solid rgba(255, 255, 255, 0.1); display: flex; flex-direction: column; position: fixed; height: 100vh; height: 100dvh; left: 0; top: 0; z-index: 100; }
...
.nav-item.admin-link { background: linear-gradient(135deg, rgba(139, 92, 246, 0.1) 0%, rgba(236, 72, 153, 0.1) 100%); border: 1px solid rgba(139, 92, 246, 0.3); color: #a78bfa; }
...
.mobile-menu { display: none; position: fixed; bottom: 0; left: 0; right: 0; background: #0a0a0a; border-top-left-radius: 25px; border-top-right-radius: 25px; padding: 25px; z-index: 999; transform: translateY(100%); transition: transform 0.3s ease; max-height: 80vh; overflow-y: auto; }
...
.mobile-nav-item.admin-mobile { background: linear-gradient(135deg, rgba(139, 92, 246, 0.15) 0%, rgba(236, 72, 153, 0.15) 100%); border: 1px solid rgba(139, 92, 246, 0.3); color: #a78bfa; }
...
/* Main Content */
.main-content { flex: 1; margin-left: 260px; padding: 30px; padding-bottom: calc(100px + env(safe-area-inset-bottom)); }
