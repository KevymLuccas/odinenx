...
<template>
  <div class="dashboard">
    ...
    <main class="main-content">
      <header class="page-header"><h1>Histórico</h1><p>Suas análises e operações anteriores</p></header>

      <div class="empty-state">
        <div class="icon-wrapper"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 8v4l3 3"/><circle cx="12" cy="12" r="10"/></svg></div>
        <h2>Histórico vazio</h2>
        <p>Suas análises e operações aparecerão aqui.</p>
      </div>
    </main>
  </div>
</template>
...
.icon-wrapper { width: 100px; height: 100px; background: rgba(234, 179, 8, 0.15); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 30px; }
.icon-wrapper svg { width: 50px; height: 50px; stroke: #eab308; }
